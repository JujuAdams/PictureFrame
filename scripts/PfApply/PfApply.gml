...
/// returns the result struct that is generated by an internal call to `PfCalculate()`. Please see
/// that function for more information on what variables are available.
/// 
