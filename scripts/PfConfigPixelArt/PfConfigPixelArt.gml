...
function PfConfigPixelArt(_targetWidth, _targetHeight, _fullscreen = window_get_fullscreen(), _minWidth = _targetWidth, _minHeight = _targetHeight, _maxWidth = _targetWidth, _maxHeight = _targetHeight)
{
    return {
